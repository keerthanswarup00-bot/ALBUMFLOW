...
--   - Revokes anon access to get_album_review_data
--   - Tightens activity_logs RLS
--   - Restricts share_link SELECT policy
--   - Adds rate-limiting to approve_album and request_album_changes
-- ============================================================
